# Don't get lost in data analysis


**Learn how to use RStudio Projects (and a little self discipline) to keep your work organised.**
...
```r
crimemapping::tutorial("08_projects")
```
...
```{r project-exercise2, exercise=TRUE, eval=FALSE}
