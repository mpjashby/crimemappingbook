...
```{r intro-exercise1, exercise=TRUE, error=TRUE}
...
```{r intro-exercise3, exercise=TRUE, error=TRUE}
select(frauds, offense_category)
```
...
```{r intro-exercise7, exercise=TRUE, error=TRUE}
...
```{r intro-exercise8, exercise=TRUE, error=TRUE}
message("A" "B")
```
...
```{r finding-exercise1, exercise=TRUE, error=TRUE}
library(tidyverse)
...
```{r finding-exercise2, exercise=TRUE, error=TRUE}
frauds |> 
...
```{r finding-exercise3, exercise=TRUE, exercise.lines=5, error=TRUE}
frauds |> 
#  select(offense_code, longitude, latitude) |> 
#  filter(offense_code == "26G") |> 
#  arrange(date)
...
<script>
$("#finding-box1-title").click(function () { $("#finding-box1").toggle("slow") })
</script>
...
```{r finding-exercise4, exercise=TRUE, error=TRUE}
library(sf)
...
<script>
$("#understanding-box1-title").click(function () { $("#understanding-box1").toggle("slow") })
</script>
...
```{r common-errors, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r reprex-exercise1-setup, echo=FALSE}
...
```{r reprex-exercise1, exercise=TRUE, exercise.lines=39, error=TRUE}
# Load packages
library(dplyr)
library(ggplot2)
library(readr)
...
```{r reprex-exercise2, exercise=TRUE, exercise.lines=13, exercise.setup="reprex-exercise1-setup", error=TRUE}
# Load packages
library(ggplot2)
library(readr)
...
```{r reprex-example3, exercise=TRUE, exercise.setup="reprex-exercise1-setup", error=TRUE}
library(ggplot2)
...
```{r reprex-exercise4, exercise=TRUE, exercise.lines=13, exercise.setup="reprex-exercise1-setup", error=TRUE}
# Load packages
library(ggplot2)
library(readr)
...
```{r reprex-exercise4-solution, error=TRUE}
# Load packages
library(ggplot2)
