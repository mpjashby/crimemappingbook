...
{{< video https://youtu.be/8FbywcgBpa4 >}}
...
map_choices_quiz1 <- c(
  "Map design is mostly about choosing the right colors and symbols",
...
map_choices_quiz3 <- c(
  ...
  answer = "By making large areas of color seem more important than they actually are",
...
{{< video https://youtu.be/YHE0W86tnHM >}}
...
<!--
Watch this video to find out what elements you can add to your maps to make them more useful.
