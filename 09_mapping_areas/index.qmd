...
alcaldia_counts <- hotspot_count(cdmx_car_jacking, grid = cdmx_alcaldias)
```
...
We could build on this map in several ways. For example, in @calculating-rates we will learn how to show crime _rates_ on a map, as an alternative to crime counts. But in the next section, we will learn how to make interactive crime maps.
...
## Calculating crime rates {#calculating-rates}
