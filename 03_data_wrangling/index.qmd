...
```r
crimemapping::tutorial("03_data_wrangling")
```
...
[table of functions for reading data into R](www/data_reading_functions.html) to 
remind you of which function to use to load each type of file.
