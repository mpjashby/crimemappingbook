...
![](../images/chapter_03_loading_selecting_data_illustration.png){fig-alt=""}
...
**Over the next five chapters, we will learn all the skills needed to make a good crime map in R.** You will learn to:
...
* add context to a map using titles, legends, scale bars and north arrows (@sec-map-context).
...
## Filtering rows {#sec-filter-data}
