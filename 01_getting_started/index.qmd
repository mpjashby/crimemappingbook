...
We will use a piece of software called Positron for almost all of this course. Positron is designed specifically for data analysis. If you have previous used either VSCode or RStudio, you will probably find Positron quite familiar, but if you haven't used either of those before, don't worry -- we will guide you through the basics of using Positron in this course.
...
The [Positron Cheat Sheet](https://rstudio.github.io/cheatsheets/positron.pdf) highlights some of the features available in Positron and gives a list of available keyboard short-cuts. You might want to keep this cheat sheet open in a separate window while you work through the course, or print off a version to keep with you.
...
::: {.callout-important}
#### Common mistake: bad file organisation
...
1. Click the **New Folder …** button in the Welcome panel.
...
4. Click **Browse** and choose a place on your computer to save the folder. You can choose any location you like, but the `Documents` folder in your computer is usually a good choice.
5. Click **Next**.
6. Leave the default options selected and click **Create**.
7. Click **Current Window**.
...
Now that you know why crime mapping is useful for understanding crime, why crime is typically concentrated in space and how to find your way around Positron, in the next chapter we will produce our first crime map in R.
...
<p class="credits"><a href="https://allisonhorst.com/">Artwork by @allison_horst</a></p>
