...
What to do instead
: Open a separate Positron workspace folder for each analytical project. Inside that workspace, use relative paths and the [here package](https://here.r-lib.org/) to specify where files should be stored. See @sec-create-project.
...
What to do instead
: When you want to clear the R environment, restart R using the **Restart R** (**&#10227;**) button in Positron's **Console** panel.
